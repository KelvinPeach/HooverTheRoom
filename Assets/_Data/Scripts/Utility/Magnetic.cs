...
{
	[SerializeField] Transform magnetTransform; // This script may be on a child because of potentially needing two trigger colliders (e.g. one for the magnet and one for the actual pickup)
